...
interface MockCacheAdapter extends AdapterInterface, CacheInterface
{
}

class HotkeyGetTest extends TestCase
{
    /** @var MockCacheAdapter&MockObject */
    ...
    {
        $this->decoratedMock = $this->createMock(MockCacheAdapter::class);
